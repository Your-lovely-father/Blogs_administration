<template>
  <div class="login_bg">
   <div class="box">
     <div class="login_box">
       <!--   title区域         -->
       <p class="title_h1">欢迎登陆 <span class="title_h3">王晓冷个人博客管理系统</span></p>
       <!--    表单区        -->
       <el-form :model="loginForm" class="login_form" :rules="rules" ref="loginFormRef">
         ...
         <el-form-item prop="pass">
           <el-input v-model="loginForm.pass" prefix-icon="el-icon-lock" type="password"></el-input>
         </el-form-item>
...
<script>
// import Api from '../../api/Public/Public'
export default {
  data() {
  ...
  methods: {
    ...
    login() {
      this.$refs.loginFormRef.validate(value => {
        if (!value) return;
        this.$router.push('/mainStructure');
      })
    }
  },
  computed: {}
